...
public class ProdutoController {
	...
	@PostMapping("/comfoto")
	public ResponseEntity<Produto> salvarComFoto(@RequestPart("edt") String strProduto,
			@RequestPart("img") MultipartFile arqImg) throws JsonMappingException, JsonProcessingException {
		return new ResponseEntity<>(produtoServices.salvarProdutoComFoto(strProduto, arqImg), HttpStatus.CREATED);
	}
}
